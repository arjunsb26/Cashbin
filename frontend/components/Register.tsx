  ...
  return (
    <div>
      <div className="flex flex-col gap-3 pb-4 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
        <p className="max-w-[46ch] text-caption text-ink-soft">
          {REGISTER_LINE}
        </p>
...
function AddAssetDialog() {
  ...
  const ready =
    tagOk && description.ok && Number.isFinite(costCents) && costCents > 0;
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            <Field
              ...
              htmlFor="asset-tag"
              error={
                form.tag.length > 0 && !tagOk ? "That is not a tag code." : null
              }
            >
              <Input
                id="asset-tag"
            ...
            >
              <Input
                ...
                onChange={(e) =>
                  setForm({ ...form, in_service_date: e.target.value })
                }
              />
            </Field>
            <Field
            ...
            >
              <Select
                ...
                onChange={(e) =>
                  setForm({
                    ...form,
                    tax_method: e.target.value as AssetCreate["tax_method"],
                  })
                }
              >
